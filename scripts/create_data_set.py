...
def main():
    parser = argparse.ArgumentParser(
        description="Create data set for optimal transport."
    )
    parser.add_argument(
        "--num_elements", type=int, default=300, help="Number of elements"
    )
    ...
    parser.add_argument(
        "--numb_per_data_set", type=int, default=10000, help="Number per data set"
    )
    parser.add_argument(
        "--sinkhorn_iter", type=int, default=100, help="Number of Sinkhorn iterations"
    )
    parser.add_argument("--device", type=str, default="mps", help="Device to use")
    parser.add_argument(
        "--incl_random_shapes", type=bool, default=True, help="Include random shapes"
    )
